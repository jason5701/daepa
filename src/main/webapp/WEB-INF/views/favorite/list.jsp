   ...
   <div id="favorite">
      ...
      <table id="productftbl">
         ...
         <tr class="row">
            ...
            <td width=100><img src="/displayFile?fullName=${productflist.product_image}" width=100/></td>
   ...
   <div id="favorite">
      <table id="meterialftbl">
         ...
         <tr class="row">
            ...
            <td width=100><img src="/displayFile?fullName=${meterialflist.meterial_image}" width=100/></td>
