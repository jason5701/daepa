         ...
         <table width="600">
            ...
            <tr>
               <td colspan="4" style="border-top:1px solid #EAEAEA; text-align:right; padding:20px 10px 20px 0px" >
                   <input type="submit" class="btn_style" value="답변등록" onClick="location.href='/board/product_boardQA_update?boardQA_number=${vo.boardQA_number}'"/>
               </td>
            </tr>
            <tr>
             <td colspan="4" style="border-top:2px solid;"></td>
...
<script>
   ...
   $(frm).on("submit", function(e){      
      ...
      if(!confirm(product_id + product_name + "상품문의를 등록하실래요?")) return;
      frm.action="product_boardQA_update";
      frm.method="post"; 
      frm.submit();
      alert("등록이 완료되었습니다.");
   });
